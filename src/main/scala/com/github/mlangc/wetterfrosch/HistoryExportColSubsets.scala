...
object HistoryExportColSubsets {
  ...
  val ColsForLast2DaysFromTree100 = Seq(
    Set("Wind Direction daily mean [80 m above gnd]", "Day", "Wind Speed daily min [80 m above gnd]", "Month", "Relative Humidity daily min [2 m above gnd]", "Wind Direction daily mean [900 mb]", "Wind Speed daily min [900 mb]", "Wind Gust daily min [sfc]", "Wind Speed daily max [900 mb]", "High Cloud Cover daily min [high cld lay]", "Mean Sea Level Pressure daily mean [MSL]", "Shortwave Radiation daily sum [sfc]", "Mean Sea Level Pressure daily max [MSL]", "Wind Speed daily min [10 m above gnd]", "Wind Speed daily mean [10 m above gnd]", "Mean Sea Level Pressure daily min [MSL]", "Temperature daily mean [2 m above gnd]", "Wind Speed daily max [80 m above gnd]", "Relative Humidity daily mean [2 m above gnd]", "Medium Cloud Cover daily mean [mid cld lay]"),
    Set("High Cloud Cover daily max [high cld lay]", "Wind Direction daily mean [80 m above gnd]", "Sunshine Duration daily sum [sfc]", "Wind Speed daily min [80 m above gnd]", "Wind Gust daily max [sfc]", "Temperature daily max [2 m above gnd]", "Relative Humidity daily min [2 m above gnd]", "Wind Direction daily mean [10 m above gnd]", "Medium Cloud Cover daily min [mid cld lay]", "Wind Direction daily mean [900 mb]", "Wind Speed daily min [900 mb]", "Wind Gust daily mean [sfc]", "Wind Speed daily mean [900 mb]", "Wind Gust daily min [sfc]", "Wind Speed daily max [900 mb]", "High Cloud Cover daily min [high cld lay]", "Total Cloud Cover daily mean [sfc]", "Mean Sea Level Pressure daily mean [MSL]", "Total Precipitation daily sum [sfc]", "High Cloud Cover daily mean [high cld lay]", "Wind Speed daily max [10 m above gnd]", "Shortwave Radiation daily sum [sfc]", "Wind Speed daily mean [80 m above gnd]", "Mean Sea Level Pressure daily max [MSL]", "Wind Speed daily mean [10 m above gnd]", "Relative Humidity daily max [2 m above gnd]", "Mean Sea Level Pressure daily min [MSL]", "Wind Speed daily max [80 m above gnd]", "Relative Humidity daily mean [2 m above gnd]", "Medium Cloud Cover daily mean [mid cld lay]")
  )

  val ColsForLast2DaysFromTree75 = Seq(
    Set("Wind Direction daily mean [80 m above gnd]", "Day", "Wind Speed daily min [80 m above gnd]", "Month", "Relative Humidity daily min [2 m above gnd]", "Wind Direction daily mean [900 mb]", "Wind Speed daily min [900 mb]", "Wind Gust daily min [sfc]", "Wind Speed daily max [900 mb]", "High Cloud Cover daily min [high cld lay]", "Mean Sea Level Pressure daily mean [MSL]", "Shortwave Radiation daily sum [sfc]", "Wind Speed daily min [10 m above gnd]", "Wind Speed daily mean [10 m above gnd]", "Mean Sea Level Pressure daily min [MSL]", "Temperature daily mean [2 m above gnd]", "Wind Speed daily max [80 m above gnd]", "Relative Humidity daily mean [2 m above gnd]"),
    Set("Wind Direction daily mean [80 m above gnd]", "Sunshine Duration daily sum [sfc]", "Wind Speed daily min [80 m above gnd]", "Wind Gust daily max [sfc]", "Temperature daily max [2 m above gnd]", "Relative Humidity daily min [2 m above gnd]", "Wind Direction daily mean [10 m above gnd]", "Medium Cloud Cover daily min [mid cld lay]", "Wind Direction daily mean [900 mb]", "Wind Speed daily min [900 mb]", "Wind Gust daily mean [sfc]", "Wind Gust daily min [sfc]", "Wind Speed daily max [900 mb]", "High Cloud Cover daily min [high cld lay]", "Mean Sea Level Pressure daily mean [MSL]", "Total Precipitation daily sum [sfc]", "High Cloud Cover daily mean [high cld lay]", "Wind Speed daily max [10 m above gnd]", "Shortwave Radiation daily sum [sfc]", "Wind Speed daily mean [80 m above gnd]", "Mean Sea Level Pressure daily max [MSL]", "Mean Sea Level Pressure daily min [MSL]", "Wind Speed daily max [80 m above gnd]", "Relative Humidity daily mean [2 m above gnd]", "Medium Cloud Cover daily mean [mid cld lay]")
  )
